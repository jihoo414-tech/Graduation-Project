...
from app.dto.shared.prediction import (
...
from app.repository.model_artifacts import ModelArtifactPaths, artifact_paths_from_env
from app.service.inference.ensemble_runtime import run_ensemble
from app.service.inference.survival_curve import build_km_curve
...
def _load_km_rows(paths: ModelArtifactPaths):
    from app.repository.model_artifacts import load_km_rows
